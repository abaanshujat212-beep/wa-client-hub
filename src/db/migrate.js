...
const MIGRATIONS = [
  ['001_canonical_schema', 'docs/schema.sql'],
  ['002_openwa_adapter', 'docs/migrations/002_openwa_adapter.sql'],
  ['003_unified_inbox', 'docs/migrations/003_unified_inbox.sql'],
  ['004_safe_campaigns', 'docs/migrations/004_safe_campaigns.sql'],
  ['005_connector_framework', 'docs/migrations/005_connector_framework.sql'],
  ['006_provider_connectors', 'docs/migrations/006_provider_connectors.sql'],
  ['007_canonical_send', 'docs/migrations/007_canonical_send.sql'],
  ['008_meta_connections', 'docs/migrations/008_meta_connections.sql'],
  ['009_meta_signup_states', 'docs/migrations/009_meta_signup_states.sql'],
  ['010_meta_signup_rate_limits', 'docs/migrations/010_meta_signup_rate_limits.sql'],
  ['011_meta_connection_lifecycle', 'docs/migrations/011_meta_connection_lifecycle.sql'],
